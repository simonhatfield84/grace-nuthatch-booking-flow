...
'Homepage analytics summary view running with SECURITY INVOKER. Access is controlled by RLS policies on the underlying homepage_analytics table, which currently only allows super admins to view data.';
